...
- **Zhanzhongyu Gao**, Xun Xiao, Huadong Mo, Daoyi Dong, A Physics-informed Power Curve Model for Wind Turbine Condition Monitoring. Major revision for **Reliability Engineering & System Safety**
- Kai Li, Yi Luo, Xiujie Zhao, Xun Xiao, Condition-based Maintenance Strategy for Dynamic Mission-oriented Systems. Under review for **Naval Research Logistics**
- **Zhanzhongyu Gao**, Xun Xiao, Huadong Mo, Daoyi Dong, A computational framework for censoring design in monitoring lifetime data from one-dimensional exponential families. Minor revision for **Journal
of Quality Technology**
- Chao Wu, Y. Du, Y. Liang, Xun Xiao, An efficient calibration algorithm for multiscale geographically and temporally weighted regression. Minor revision for **International Journal of
Geographical Information Science**

## Statistics
- Piao Chen, Xun Xiao, Novel Closed-form Point Estimators for the Beta Distribution. Accepted by **Statistical Theory and Related Fields**
...
- Peng Li, Xun Xiao, Jiayu Chen, Estimating mean time to failure of solid-state drives via self-organizing map and model averaging. Accepted by **IEEE Transactions on Reliability**
...
## Energy 
- Michael Jack, Pablo Paulsen, Xun Xiao, Rafferty Parker, Daniel Myall, Seasonal Electricity Demand of Future Electric Vehicle Fleets. Accepted by **Energy**
